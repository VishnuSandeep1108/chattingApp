...
import RetrievedChats from "../Chats/retrievedChats.js";
...
function Home(props)
{
    ...
    const {username, chatHistory, updatereceiver, updatemessage, sendMessage, updatesender, addSender, newMessageAlert, updatenewMessageAlert, handleVideoCall} = props;
    ...
    return (
        <div className="home">
            ...
            <div className="flex-child right">
                {wantedChats.length?<RetrievedChats wantedConnection={wantedConnection} wantedChats={wantedChats} updatereceiver={updatereceiver} updatemessage={updatemessage} sendMessage={sendMessage} chatHistory={chatHistory} handleVideoCall={handleVideoCall}/>:<Welcome />}
            </div>
            </div>
        </div>
    )
