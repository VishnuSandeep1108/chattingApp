...
import "./retrievedChats.css";

function RetrievedChats(props)
{
    const {wantedConnection, wantedChats, updatemessage, sendMessage, chatHistory, handleVideoCall} = props;
    ...
    return (
        <div className="sub-right">
            <div className="wantedConnection"><box-icon type='solid' name='user' /><h3>{wantedConnection}</h3><button className="videocallButton" onClick={handleVideoCall}>Video Call</button></div>
